...
// Github: https://github.com/erica/NSDate-Extensions
...
- (BOOL)isSameMonthAsDate:(NSDate *)aDate
{
    NSDateComponents *components1 =
        [[NSDate currentCalendar] components:NSCalendarUnitYear | NSCalendarUnitMonth fromDate:self];
    NSDateComponents *components2 =
        [[NSDate currentCalendar] components:NSCalendarUnitYear | NSCalendarUnitMonth fromDate:aDate];
...
- (NSDate *)changeYear:(NSInteger)year
...
{
    return [self changeYear:self.year month:1 day:1 hour:0 minute:0 second:0];
}

- (NSDate *)beginningOfMonth
{
    return [self changeYear:self.year month:self.month day:1 hour:0 minute:0 second:0];
}

- (NSDate *)beginningOfDay
{
    return [self changeYear:self.year month:self.month day:self.day hour:0 minute:0 second:0];
}

- (NSDate *)endOfYear
{
    return [self changeYear:self.year month:12 day:31 hour:23 minute:59 second:59];
}
...
- (NSDate *)endOfMonth
{
    ...
    return [self changeYear:self.year month:self.month day:lastDay hour:23 minute:59 second:59];
}

- (NSDate *)endOfDay
{
    return [self changeYear:self.year month:self.month day:self.day hour:23 minute:59 second:59];
}
